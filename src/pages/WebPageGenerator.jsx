...
import webImage from '../assets/undraw_website-setup_o2zf 1.png'
import { useNavigate } from "react-router-dom";

const WebPageGenerator = () => {
  const [audience, setAudience] = useState('Select audience');
  const [language, setLanguage] = useState('Select language');
  const [summaryType, setSummaryType] = useState('Summary Type');
  ...
  return (
    <Container fluid className="email-generator p-4">
      <div className="d-flex justify-content-between align-items-center mb-3">
        ...
        <Button className="generate-btn" onClick={()=>navigate('/web-page-preview')}>Generate Content</Button>
      </div>
      ...
      <Row>
        <Col md={8}>
          <Form>
              ...
              <Form.Label className="form-label-custom">Summary Type</Form.Label>
              <Dropdown onSelect={(eventKey) => setSummaryType(eventKey)}>
                <Dropdown.Toggle
                  variant="secondary"
                  className="custom-dropdown-toggle-web-page-generator w-100 input-dark text-start"
                >
                  {summaryType}
                </Dropdown.Toggle>
                <Dropdown.Menu className="w-100 custom-dropdown-menu-web-page-generator">
                  <Dropdown.Item eventKey="HCP">Descriptive</Dropdown.Item>
                  <Dropdown.Item eventKey="Patients">Explanatory</Dropdown.Item>
                  <Dropdown.Item eventKey="HCP">Evaluative</Dropdown.Item>
                  <Dropdown.Item eventKey="Patients">Executive</Dropdown.Item>
                </Dropdown.Menu>
              </Dropdown>
            </Form.Group>
            ...
            <Form.Group className="mb-4">
              ...
              <Form.Control
                ...
                rows={2}
                placeholder="Topic"
                className="input-dark-web-page-generator"
              />
            </Form.Group>
          </Form>
        </Col>
        ...
        >
          <h5 className="text-white mb-3 ">AI Powered Web Page Creation</h5>
          <img
            src={webImage}
            alt="Web Page Visual"
