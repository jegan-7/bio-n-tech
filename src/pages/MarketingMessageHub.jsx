...
const projectTypes = [
  { label: 'Dynamic Banner', bg: '#4b5d78' },
  { label: 'Email', bg: '#8a7348' },
  { label: 'Webpage', bg: '#42645a' },
  { label: 'Brochure', bg: '#5d5173' },
  { label: 'lorem', bg: '#6e4e41' },
  { label: 'lorem', bg: '#694f67' }
];
...
const MarketingMessageHub = () => {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: "#252632" }}
    >
      {/* Header */}
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h5>Marketing Message Hub</h5>
        <button
          className="btn btn-success"
          style={{ width: "165px",backgroundColor:'#015A63',border:'transparent' }}
          ...
          <div className="row">
            {projectTypes.map((proj, idx) => (
              <div className="col-md-4 mb-3" key={idx}>
                <div
                  className="d-flex align-items-center justify-content-start p-3 rounded"
                  style={{
