...
import emailImage from '../assets/undraw_email-campaign_2z6t 1 (1).png'
  ...
  return (
    <Container fluid className="email-generator p-4">
      ...
      <div className="d-flex justify-content-between align-items-center mb-3">
        <h5 className="email-title d-flex align-items-center" style={{color:'black'}}>
      ...
      <Row>
        ...
        >
          <h5 className="ai-powered mb-3">AI Powered Email Creation</h5>
          <img
            src={emailImage}
            alt="Email Visual"
